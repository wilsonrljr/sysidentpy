...
aic = model1.information_criterion(y,u,'Akaike')
plt.plot(reference, aic, 'o--')
plt.show()

bic = model1.information_criterion(y,u,'Bayes')
plt.plot(reference, bic, 'o--')
plt.show()

fpe = model1.information_criterion(y,u,'FPE')
plt.plot(reference, fpe, 'o--')
plt.show()

lilc = model1.information_criterion(y,u,'LILC')
