...
def test_get_siso_data_default():
    ...
    x_train, x_valid, y_train, _y_valid = get_siso_data()
...
def test_get_siso_data_colored_noise():
    ...
    x_train, x_valid, _y_train, _y_valid = get_siso_data(colored_noise=True)
...
def test_get_siso_data_custom_train_percentage():
    ...
    x_train, x_valid, _y_train, _y_valid = get_siso_data(train_percentage=80)
...
def test_get_miso_data_default():
    ...
    x_train, x_valid, y_train, _y_valid = get_miso_data()
...
def test_get_miso_data_colored_noise():
    ...
    x_train, x_valid, _y_train, _y_valid = get_miso_data(colored_noise=True)
...
def test_get_miso_data_custom_train_percentage():
    ...
    x_train, x_valid, _y_train, _y_valid = get_miso_data(train_percentage=80)
