...
def test_simulate():
    ...
    s = SimulateNARMAX(basis_function=PolynomialBasis(), estimate_parameter=False)
...
def test_simulate_theta():
    ...
    s = SimulateNARMAX(basis_function=PolynomialBasis(), estimate_parameter=True)
...
def test_estimate_parameter():
    ...
    assert_raises(TypeError, SimulateNARMAX, estimate_parameter='False', x_train=x_train, y_train=y_train, basis_function=PolynomialBasis())
...
def test_default_values():
    ...
    model = SimulateNARMAX(basis_function=PolynomialBasis())
    model_values = [
        model._n_inputs,
        model.estimator,
